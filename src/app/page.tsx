      ...
      >
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            <Image className="p-8 lg:p-14 heroImage" src="/hero.png" alt="landing" width={500} height={300} />
            <div className="landingForm justify-center">
              <div className="justify-center">
                ...
                <div className="mb-5 text-base leading-relaxed text-white sm:text-lg md:text-xl max-w-3xl">
                  ...
                  The peaceful quota reform movement, initially advocating for equal job opportunities, escalated into nationwide unrest due to the government's harsh response.
